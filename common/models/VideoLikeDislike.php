...
/**
 * This is the model class for table "video_like_dislike".
 *
 * @property int $id
 ...
 */
class VideoLikeDislike extends \yii\db\ActiveRecord
{
    const LIKE = 1;
    const DISLIKE = 0;
    ...
    {
        return [
            [['video_id', 'user_id', 'created_at'], 'required'],
