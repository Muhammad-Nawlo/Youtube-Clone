...
<header>
    ...
    <form class="d-flex m-auto" action="<?= Url::to(['/video/search'])?>" method="GET">
        <input class="form-control mr-2" type="search" placeholder="Search" name="keyword" value="<?= Yii::$app->request->get('keyword')?>">
